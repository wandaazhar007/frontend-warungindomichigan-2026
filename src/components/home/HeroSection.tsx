...
export default function HeroSection() {
  ...
  const trustBadges = [t('badges.halal'), t('badges.freshShipped'), t('badges.nationwide')];
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[520px]">
              ...
              <div className="absolute -top-3 right-4 text-center px-3 py-2 rounded-xl shadow-md bg-wim-yellow"
                ...
                <p className="text-[16px] font-extrabold text-black leading-none">{t('shipsToday')}</p>
                <p className="text-[14px] text-black/80 mt-0.5">{t('orderBefore2pm')}</p>
              </div>
